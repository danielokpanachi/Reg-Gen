...
export default {
  ...
  data() {
    return {
      ...
      organizations: ["Test Org 1", "Test Org 2", "Test Org 3", "Test Org 4",],
      showAddPopup: false,
      newOrgCode: '',
      dropdown1: '1',
      dropdown2: '1',
...
senderDepartment : this.senderDepartment
  ...
  // Always push a new entry, even if one already exists for the same organization name
  ...
  alert(`Reference Generated: ${this.referenceNumber}`);
    ...
    addOrganization() {
     const newOrg =` New Org ${this.organizations.length + 1}`;
